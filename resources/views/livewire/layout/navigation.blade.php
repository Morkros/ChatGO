            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" wire:navigate>
                        <x-chatgo-logo class="block h-16 w-auto fill-current text-gray-200" />
                    </a>
                </div>
...
<<<<<<< Updated upstream
                <div wire:offline>
                    Estás desconectado. Reconectando...
                </div>
...
=======
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-400 bg-gray-800 hover:text-gray-300 focus:outline-none transition ease-in-out duration-150">
                            <div x-data="{{ json_encode(['username' => auth()->user()->username]) }}" x-text="username" x-on:profile-updated.window="username = $event.detail.name"></div>
>>>>>>> Stashed changes
